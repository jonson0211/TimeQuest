...
public class StepView extends View {
    ...
    public StepView(Context context, AttributeSet attrs) {
        this(context, attrs, com.shuhart.stepview.R.attr.sv_stepViewStyle);
    }
    ...
    private void applyStyles(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray ta = context.obtainStyledAttributes(attrs, com.shuhart.stepview.R.styleable.StepView, defStyleAttr, com.shuhart.stepview.R.style.StepView);
        selectedCircleColor = ta.getColor(com.shuhart.stepview.R.styleable.StepView_sv_selectedCircleColor, 0);
        selectedCircleRadius = ta.getDimensionPixelSize(com.shuhart.stepview.R.styleable.StepView_sv_selectedCircleRadius, 0);
        selectedTextColor = ta.getColor(com.shuhart.stepview.R.styleable.StepView_sv_selectedTextColor, 0);
        selectedStepNumberColor = ta.getColor(com.shuhart.stepview.R.styleable.StepView_sv_selectedStepNumberColor, 0);
        doneStepMarkColor = ta.getColor(com.shuhart.stepview.R.styleable.StepView_sv_doneStepMarkColor, 0);
        doneCircleColor = ta.getColor(com.shuhart.stepview.R.styleable.StepView_sv_doneCircleColor, 0);
        doneCircleRadius = ta.getDimensionPixelSize(com.shuhart.stepview.R.styleable.StepView_sv_doneCircleRadius, 0);
        doneTextColor = ta.getColor(com.shuhart.stepview.R.styleable.StepView_sv_doneTextColor, 0);
        nextTextColor = ta.getColor(com.shuhart.stepview.R.styleable.StepView_sv_nextTextColor, 0);
        stepPadding = ta.getDimensionPixelSize(com.shuhart.stepview.R.styleable.StepView_sv_stepPadding, 0);
        nextStepLineColor = ta.getColor(com.shuhart.stepview.R.styleable.StepView_sv_nextStepLineColor, 0);
        doneStepLineColor = ta.getColor(com.shuhart.stepview.R.styleable.StepView_sv_doneStepLineColor, 0);
        stepLineWidth = ta.getDimensionPixelSize(com.shuhart.stepview.R.styleable.StepView_sv_stepLineWidth, 0);
        textPadding = ta.getDimensionPixelSize(com.shuhart.stepview.R.styleable.StepView_sv_textPadding, 0);
        stepNumberTextSize = ta.getDimension(com.shuhart.stepview.R.styleable.StepView_sv_stepNumberTextSize, 0);
        textSize = ta.getDimension(com.shuhart.stepview.R.styleable.StepView_sv_textSize, 0);
        animationDuration = ta.getInteger(com.shuhart.stepview.R.styleable.StepView_sv_animationDuration, 0);
        animationType = ta.getInteger(com.shuhart.stepview.R.styleable.StepView_sv_animationType, 0);
        stepsNumber = ta.getInteger(com.shuhart.stepview.R.styleable.StepView_sv_stepsNumber, 0);
        nextStepCircleEnabled = ta.getBoolean(com.shuhart.stepview.R.styleable.StepView_sv_nextStepCircleEnabled, false);
        nextStepCircleColor = ta.getColor(com.shuhart.stepview.R.styleable.StepView_sv_nextStepCircleColor, 0);
        CharSequence[] descriptions = ta.getTextArray(com.shuhart.stepview.R.styleable.StepView_sv_steps);
        ...
        Drawable background = ta.getDrawable(com.shuhart.stepview.R.styleable.StepView_sv_background);
        if (background != null) {
            setBackgroundDrawable(background);
        }
        int fontId = ta.getResourceId(com.shuhart.stepview.R.styleable.StepView_sv_typeface, 0);
        if (fontId != 0) {
    ...
    private void drawStep(Canvas canvas, int step, int circleCenterX, int circleCenterY) {
        // to do: fix alpha for text when going back/forward
        // to do: don't scale up/down numbers if circles are not scaled
    ...
    public class State {
        ...
        @AnimationType
        private int animationType = com.example.timequest.StepView.this.animationType;
        @ColorInt
        private int selectedCircleColor = com.example.timequest.StepView.this.selectedCircleColor;
        @Dimension
        private int selectedCircleRadius = com.example.timequest.StepView.this.selectedCircleRadius;
        @ColorInt
        private int selectedTextColor = com.example.timequest.StepView.this.selectedTextColor;
        @ColorInt
        private int doneCircleColor = com.example.timequest.StepView.this.doneCircleColor;
        @Dimension
        private int doneCircleRadius = com.example.timequest.StepView.this.doneCircleRadius;
        @ColorInt
        private int doneTextColor = com.example.timequest.StepView.this.doneTextColor;
        @ColorInt
        private int nextTextColor = com.example.timequest.StepView.this.nextTextColor;
        @Dimension
        private int stepPadding = com.example.timequest.StepView.this.stepPadding;
        @ColorInt
        private int nextStepLineColor = com.example.timequest.StepView.this.nextStepLineColor;
        @ColorInt
        private int doneStepLineColor = com.example.timequest.StepView.this.doneStepLineColor;
        @Dimension
        private int stepLineWidth = com.example.timequest.StepView.this.stepLineWidth;
        @Dimension(unit = Dimension.SP)
        private float textSize = com.example.timequest.StepView.this.textSize;
        @Dimension
        private int textPadding = com.example.timequest.StepView.this.textPadding;
        @ColorInt
        private int selectedStepNumberColor = com.example.timequest.StepView.this.selectedStepNumberColor;
        @Dimension(unit = Dimension.SP)
        private float stepNumberTextSize = com.example.timequest.StepView.this.stepNumberTextSize;
        @ColorInt
        private int doneStepMarkColor = com.example.timequest.StepView.this.doneStepMarkColor;
        private int animationDuration = com.example.timequest.StepView.this.animationDuration;
        private boolean nextStepCircleEnabled = com.example.timequest.StepView.this.nextStepCircleEnabled;
        @ColorInt
        private int nextStepCircleColor = com.example.timequest.StepView.this.nextStepCircleColor;
        ...
        public void commit() {
             com.example.timequest.StepView.this.animationType = animationType;
            com.example.timequest.StepView.this.selectedTextColor = selectedTextColor;
            com.example.timequest.StepView.this.selectedCircleRadius = selectedCircleRadius;
            com.example.timequest.StepView.this.selectedCircleColor = selectedCircleColor;
            com.example.timequest.StepView.this.doneCircleColor = doneCircleColor;
            com.example.timequest.StepView.this.doneCircleRadius = doneCircleRadius;
            com.example.timequest.StepView.this.doneTextColor = doneTextColor;
            com.example.timequest.StepView.this.nextTextColor = nextTextColor;
            com.example.timequest.StepView.this.stepPadding = stepPadding;
            com.example.timequest.StepView.this.nextStepLineColor = nextStepLineColor;
            com.example.timequest.StepView.this.doneStepLineColor = doneStepLineColor;
            com.example.timequest.StepView.this.stepLineWidth = stepLineWidth;
            com.example.timequest.StepView.this.textSize = textSize;
            com.example.timequest.StepView.this.textPadding = textPadding;
            com.example.timequest.StepView.this.selectedStepNumberColor = selectedStepNumberColor;
            com.example.timequest.StepView.this.stepNumberTextSize = stepNumberTextSize;
            com.example.timequest.StepView.this.doneStepMarkColor = doneStepMarkColor;
            com.example.timequest.StepView.this.animationDuration = animationDuration;
            setTypeface(typeface);
            com.example.timequest.StepView.this.nextStepCircleEnabled = nextStepCircleEnabled;
            com.example.timequest.StepView.this.nextStepCircleColor = nextStepCircleColor;
            if (steps != null && !com.example.timequest.StepView.this.steps.equals(steps)) {
                com.example.timequest.StepView.this.setSteps(steps);
            } else if (stepsNumber != 0 && stepsNumber != com.example.timequest.StepView.this.stepsNumber) {
                com.example.timequest.StepView.this.setStepsNumber(stepsNumber);
            } else {
                com.example.timequest.StepView.this.invalidate();
            }
        }
    }
}
